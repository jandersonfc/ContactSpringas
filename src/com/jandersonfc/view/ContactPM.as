package com.jandersonfc.view
{
	...
	[RouteEvents]
	[Event(name="getContacts")]
	[Event(name="saveContact")]
	[Event(name="removeContact")]
	[Component]
	public class ContactPM extends EventDispatcher
	{	
		...
		[EventHandler(name="returnContacts")]
		...
		[EventHandler(name="savedContact")]
		[EventHandler(name="removedContact")]
